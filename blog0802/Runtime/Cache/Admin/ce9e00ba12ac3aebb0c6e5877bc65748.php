                ...
                <div class="example">
                    <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                        <button type="button" class="btn btn-outline btn-default">
                            <i class="glyphicon glyphicon-plus" aria-hidden="true"> 添加分类</i>
                        </button>
                    </div>
                    <br><br>
                    <div class="row">
                                ...
                                <div class="ibox-content">
                                         ...
                                         role="grid">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" placeholder="查找分类" class="input form-control">
                                    ...
                                    <hr />
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable"
                                            ...
                                            <tbody>
                                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cates): $mod = ($i % 2 );++$i;?><tr class="gradeA even">
                                                    <td class="sorting_1"><?php echo ($cates["cat_id"]); ?></td>
                                                    <td class=" "><?php echo ($cates["cat_name"]); ?></td>
                                                    <td class="center "><a href="<?php echo U('Cate/CateDel', array('cat_id'=>$cates['cat_id']));?>">删除</a> <a href="<?php echo U('Cate/edit', array('cat_id'=>$cates['cat_id']));?>">修改</a></td>
