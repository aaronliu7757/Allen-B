...
<head>
    ...
    <title>Allen BABA博客管理系统</title>
    <link href="/0802/blog0802/Public/Admin/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="/0802/blog0802/Public/Admin/css/style.min.css" rel="stylesheet">
    <link href="/0802/blog0802/Public/Admin/css/login.min.css" rel="stylesheet">
    <script type="text/javascript" src="/0802/blog0802/Public/Public/layer/jquery-1.8.3.min.js"></script>
...
<body class="signin">
    <div class="signinpanel">
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <div class="m-b"></div>
                    <h4>欢迎使用 <strong>Allen BABA博客管理系统</strong></h4>
                   
                </div>
            </div>
            <div class="col-sm-5">
                <form method="post" action="" id="doLogin">
                    <h4 class="no-margins">Allen BABA博客管理系统</h4>
                    <p class="m-t-md">登录</p>
        ...
        <div class="signup-footer">
            <div class="pull-left">
                &copy; 2017 All Rights Reserved. A . B
            </div>
        </div>
    </div>
</body>
